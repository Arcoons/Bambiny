...
public class MatriculaControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String alumMatr = request.getParameter("textalumMatr");
        ...
        MatriculaVO matVO = new MatriculaVO(idMatr, idAlum, alumMatr, idUsua, regiMatr, fechMatr, estaMatr);
        ...
        switch (opcion) {
            //Agregar Registro
            case 1:
                alumvo = alumdao.consultarDatos(idAlum);

                if (alumvo != null) {

                    request.setAttribute("datosConsultados", alumvo);
                    ...
                    request.getRequestDispatcher("MatInactivos.jsp").forward(request, response);
            ...
            case 3:
                ...
                if (matVO != null) {
                    ...
                    request.getRequestDispatcher("MatActivas.jsp").forward(request, response);
            ...
            case 6:
                ...
                if (alumvo != null) {
                    ...
                    request.setAttribute("mensajeError", "la matricula no se pudo encontrar");
                    request.getRequestDispatcher("MatActivos.jsp").forward(request, response);
