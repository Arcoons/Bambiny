...
public class RolDAO extends ConexionBd implements Crud {
    ...
    public ArrayList<RolVO> listar(String usuLogin) 
    {
        ...
        {
            conexion = this.obtenerConexion();
            sql = "SELECT usuario.ID_USUA, rol.NOM_ROL FROM rol INNER JOIN rolusua ON rol.ID_ROL = rolusua.ID_ROL INNER JOIN usuario ON rolusua.ID_USUA = usuario.ID_USUA WHERE usuario.CORREO_USUA=?;";  
