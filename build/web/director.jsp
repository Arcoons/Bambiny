                        ...
                        <div class="cards">
                            <div class="colu">
                                ...
                                <div class="uno">
                                    ...
                                    <div class="info">
                                        <h4>Matriculas Nuevas</h4>
                                        <p>Listado de las matriculas nuevas </p>
                                        <a href="ConsultarMat2.jsp"><i class='bx bx-log-in-circle'></i>Ingresar</a>
                                    </div>
                                </div>
                                <div class="uno">
                                    <img src="./assets/jardin/encender.png" alt="imagen">
                                    <div class="info">
                                        <h4>Matriculas Activas</h4>
                                        <p>Listado de las matriculas que estan activas </p>
                                        <a href="MatActivas.jsp"><i class='bx bx-log-in-circle'></i>Ingresar</a>
                                    </div>
                                </div>
                                <div class="uno">
                                    <img src="./assets/jardin/apagar.png" alt="imagen">
                                    <div class="info">
                                        <h4>Matriculas Inactivas</h4>
                                        <p>Listado de las matriculas que estan  inactivas </p>
                                        <a href="MatInactivos.jsp"><i class='bx bx-log-in-circle'></i>Ingresar</a>
                                    </div>
                                </div>
