...
<body>
  ...
  <header>
    ...
    <nav class="container">
      <a href="#" class="logo">Bamb<span>iny.</span></a>
      <div class="links">
        <ul>
          <li>
    ...
    <section class="showcase-area" id="home">
      ...
      <div class="container">
        <div class="showcase-info">
          <h3 class="sub-heading">Sistema de informacion</h3>
          <h1 class="heading">Bambiny</h1>
          <p class="text">Bambiny le brinda todos los servicios para solucinar todos lo problemas con sus matrículas </p>
          <div class="cta">
              <a href="Login.jsp" class="btn">Iniciar Sesion</a>
            <a href="mailto:markus@gmail.com" download class="btn secondary-btn">Contactacnos</a>
        ...
        <div class="showcase-image">
          <img src="./assets/jardin/nene3.svg" class="person" alt="markus">
          <img src="./assets/circle1.png" alt="circle" class="shape circle">
          <img src="./assets/dots.png" alt="circle" class="shape dots">
      ...
      <div class="container"> 
        <div class="about-grid">
          <div class="about-card">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="_x31__x2C_5" x="0px"
              ...
              <g>
                <circle  cx="75" cy="75" class="st0" cx="204.55" cy="161.77" r="18.37"></circle>
              </g>
              <g>
                <path class="st0"
              ...
              <g>
                <circle  cx="75" cy="75" class="st0" cx="336.85" cy="345.51" r="84.52"></circle>
              </g>
              <g>
                <path class="st1"
          ...
          <div class="about-card">
            <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="_x31__x2C_5" x="0px"
              ...
              <g>
                <circle  cx="75" cy="75" class="st0" cx="148.79" cy="123.71" r="33.07"></circle>
              </g>
              <g>
                <path class="st0"
              ...
              <g>
                <circle  cx="75" cy="75" class="st0" cx="325.17" cy="329.5" r="62.47"></circle>
              </g>
              <g>
                <path class="st1"
        ...
        <div class="about-info">
          <h3 class="sub-heading">Gestor de matrículas</h3>
          <h1 class="heading">Controle las modificaciones, <br> de sus matriculas</h1>
          <p class="text">Bambiny te facilita el manejo y la visualización de los documentos de tus alumnos, el control de
          usuarios, la renovación de matrícula, y seguimiento de las modificaciones.</p>
          <div class="cta">
              <a href="Login.jsp" class="btn">Iniciar Sesion</a>
            <a href="mailto:yoangieepinillaa@gmail.com" class="btn secondary-btn">Contactanos</a>
      ...
      <div class="container">
        <div class="skills-box">
          <div class="box-heading">
            <h3 class="sub-heading">Nuestros Modulos</h3>
            <h1 class="heading">Dejanos ayudarte </h1>
            <div class="box-desc">
              <p class="text">
                Nuestro sistema se encarga del registro, actualización y seguimiento de las matrículas, gestiona los usuarios,
                organiza y alamecena a información de los alumnos. Te ofrecemos optimizar las siguientes actividades:
              </p>
              <a href="mailto:yoangieepinillaa@gmail.com" class="btn">Contactanos</a>
          ...
          <div class="skills-wrap">
            <div class="skill">
              ...
              <div class="sk-title">Buscar datos</div>
            </div>
            ...
            <div class="skill">
              ...
              <div class="sk-title">Llenar Formularios</div>
            </div>
            ...
            <div class="skill">
              ...
              <div class="sk-title">Eliminar registros</div>
            </div>
            ...
            <div class="skill">
              ...
              <div class="sk-title">Vincular alumnos</div>
            </div>
          </div>
    ...
    <section class="services section" id="services">
      ...
      <div class="container">
        <div class="services-info">
          <h3 class="sub-heading">Nuestros Servicios</h3>
          <h1 class="heading">Lo mejor para nuestros clientes</h1>
          <p class="text">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
             Sed recusandae maxime tempora asperiores amet, beatae unde nesciunt cum
              porro adipisci mollitia autem dicta iste voluptates corrupti eveniet 
              accusamus fugiat voluptatum .
          </p>
          ...
          <div class="cta">
            ...
            <a href="#"class="btn secondary-btn">Downlaod CV</a>
          </div>
        </div>
        <div class="services-grid">
          <div class="srv-card">
            <div class="card-desc">
              <h3>Encuentra informacion rapidamente</h3>
              <p class="text">
              Atravez de filtros y listas facilita la visualización y busquedad de información especifica.
            </p>
            </div>
          ...
          <div class="srv-card">
            <div class="card-desc">
              <h3>Controla lo que ven tus usuarios</h3>
              <p class="text">
                Muestra páginas individuales a tus clientes y protege la información de tus alumnos.
              </p>
            </div>
            <a href="*" class="btn secondary-btn">Explore More</a>
          </div>
          <div class="srv-card">
            <div class="card-desc">
              <h3>Registros dinamicos y rápidos</h3>
              <p class="text">
                Formularios sencillos y practicos para el usuario, sin demasiados campos, ni dificil de entender.
              </p>
            </div>
            <a href="*" class="btn secondary-btn">Explore More</a>
          </div>
          <div class="srv-card">
            <div class="card-desc">
              ...
              <p class="text">
                Todos tus archivos y lo de tus clientes van a estar protegidos, restinguimos a los terceros toda la informacion que quieras
              </p>
            </div>
            <a href="*" class="btn secondary-btn">Explore More</a>
      ...
      <div class="container">
        <div class="portfolio-header">
          <div class="portfolio-title">
           ...
           <h1 class="heading">Lastest Projects</h1>
          </div>
          <div class="filter-btns">
            <button class="filter-btn" data-filter="all">All</button>
            <button class="filter-btn" data-filter=".product">Product</button>
            <button class="filter-btn" data-filter=".inter">Interacting</button>
    ...
    <section class="testimonials section">
      <div class="container">
        <div class="section-background">
          <img src="./assets/jardin/tarjetas.svg" class="person" alt="">
          <img src="./assets/circle2.png" class="circle">
          <img src="./assets/square1.png" class="square">
        </div>
        <div class="swiper">
            ...
            <div class="swiper-slide">
              <div class="client">
                ...
                <div class="client-info">
                  ...
                  <h5>Executive Officer <a href="#">@ABERenergy</a></h5>
                </div>
              </div>
              <q class="text">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Ipsum ullam magni tempore dolores culpa doloremque ipsam
                perspiciatis? Molestiae illum, voluptatibus optio ullam
                neque quibusdam omnis et ab accusamus velit! Rem!
              </q>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./assets/testi2.png">
                <div class="client-info">
                  <h4>Witolf sss</h4>
          ...
          <div class="testimonials-title">
            <h3 class="sub-heading">Testimonios</h3>
            <h1 class="heading">Escucha a nuestros clientes felices</h1>
    ...
    <section class="contact section" id="contact">
      ...
      <img src="./assets/square2.png" class="shape square">
        <div class="contact-info">
          <h3 class="sub-heading">Contactanos</h3>
          <h1 class="heading">Trabajemos Juntos</h1>
          <p class="text">No esperes mas!! <br> garantizamos la funcionalidad de nuestro ssitemas y sabemos que no solo vas a optimizar tus activiades en relacion con todo el tedioso proceso de matricula,
             si no tambien vamos a disminuir tu tiempo de trabajo dejando mucho mas tiempo para disfrutar de tu familia, amigos y dedicarte a todo lo que quieras hacer.
          </p>
          <a href="mailto:yoangieepinillaa@gmail.com" class="mail">
            yoangieepinillaa@gmail.com <i class="uil uil-arrow-right"></i>
          </a>
        </div>
        <form action="index.html" class="contact-form">
          ...
          <textarea name="" id="" cols="30" rows="10" class="form-input" placeholder="Project Details" required></textarea>
...
<!-- --------- Footer --------- -->
  <footer>
    ...
    <div class="container">
      <a href="#" class="logo">Portaf<span>olio.</span></a>
