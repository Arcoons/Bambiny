            ...
            <div class="contenido">
                ...
                <div class="container arriba">
                    <div>
                        ...
                        <div class="pag">
                            <a href="MenuAdmin.jsp">Inicio</a><a>>></a><a href="admin.jsp" >Usuarios</a>
                        </div>
                    </div>    
                    <div class="boton">
                ...
                <div class="container arriba">
                    <center>
                    <table id="example" class="table table-striped" style=" width: 50em; margin-left: 1em;" >
                        <thead>
                            <tr>
                                <th>Usuario</th>
                                <th>Estado</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="Usuario">
                                    ...
                                    <input type="hidden" value="<%=usuVO.getCorreo_usua()%>" name="loginUsuario">
