            ...
            <div class="contenido">
                <div class="container arriba">
                    <div>
                        ...
                        <div class="pag">
                            <a href="alumno.jsp">Inicio</a><a> >> </a><a href="listarDocumentos.jsp" >listar Documentos</a><a> >> </a><a >Actualizar Documentos</a>
                        </div>
                    </div>    
                    <div class="boton">
                            ...
                            <div class="details personal">
                                ...
                                <div class="fields">
                                    ...
                                    <div class="input-field">
                                        ...
                                        <input type="file" name="textarchivo_docu" value=" <%= doVO.getArchivo_docu()%>" required id="tipo">
                                    </div>
