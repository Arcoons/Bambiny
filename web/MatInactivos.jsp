<%-- 
    Document   : MatInactivos
    Created on : 25-nov-2022, 21:52:32
    Author     : yoang
--%>
            ...
            <div class="contenido">
                ...
                <div class="container arriba">
                    <div>
                        ...
                        <div class="pag">
                            <a href="director.jsp">Inicio</a><p> >> </p><a href="MatInactivos.jsp" >Matriculas Inactivas</a>
                        </div>
                    </div>    
                    <div class="boton">
                ...
                <% } %>
                <div class="container ">    
                    <h1>Matriculas por inactivas</h1>
                    ...
                    <table id="example" class="table table-striped" >
                        ...
                        <%
                            ...
                            ArrayList<MatriculaVO> listaMatrEst = matDAO.listarInactivas();
